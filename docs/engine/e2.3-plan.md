...
3. **Telemetry/History path:** extend `RoomStatsSink` consumers (history listeners, exporters) so the new spawn/tombstone/harvest counters make it to dashboards/logs.
