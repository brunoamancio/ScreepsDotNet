...
4. **Movement crash handlers ☐** –
   ...
   - The next phase is to port the rest of the matrix behaviors (pull/push swaps, spawn stomps, lethal exits) and route actual crash victims through `ICreepDeathProcessor`.
