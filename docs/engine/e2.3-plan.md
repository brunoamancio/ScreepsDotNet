...
4. **Movement crash handlers ☐** –
   ...
   - Remaining work: detect true lethal outcomes (tile overflows, failed cross-room exits, bad pull chains) and route those losers through the death processor so stats/logs stay accurate.
