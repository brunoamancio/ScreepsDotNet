...
**Deliverables:**
- 83 passing behavioral tests: Harvest (2), Controller (3), Transfer (3), Link (4), Lab (3), Combat (8), Movement (11), Build/Repair (8), Spawn (7), Nuker (4), PowerSpawn (4), Factory (5), Edge Cases (14), Validation (7), Comparator (5)
- 4 JSON fixtures shared with Node.js harness: harvest_basic, transfer_basic, controller_upgrade, link_transfer
...
- 7 parity tests with `[Trait("Category", "Parity")]`:
  - 3 .NET-only tests (verify mutations produced)
  - 4 Node.js comparison tests (field-by-field parity validation)
...
**Result:** Full comparison flow wired, ready for live testing.
...
| Phase 5: CI Automation | 2-3 hours | - | ⏳ TODO |
| Phase 6: Documentation | 1-2 hours | - | ⏳ TODO |
...
### Phase 4 (Coverage) ✅
1. ✅ 83 behavioral tests covering E1-E6 features (>40 required)
2. ✅ All E2 handler families have tests (11/11)
3. ✅ E3 validation rules tested (7 tests)
...
7. ✅ Edge cases tested (14 tests)
8. ✅ E9 exclusion documented

### Phase 5-6 (Automation) ⏳
1. ⏳ Parity tests run in CI/CD
2. ⏳ Regression detection operational
3. ✅ Documentation updated (this file, roadmap)
4. ⏳ Operator playbook entry added
...
| **Parity** | 7 | .NET vs Node.js engine comparison | `dotnet test --filter Category=Parity` |
...
- `src/ScreepsDotNet.Engine.Tests/Parity/Tests/EndToEndParityTests.cs` - 7 parity tests
