...
- ✅ `PathfinderService` now calls into the native library unconditionally (managed A* fallback removed on January 13, 2026; missing binaries fail initialization).
