...
public sealed class CreepBuildRepairStepTests
{
    ...
    public async Task ExecuteAsync_BuildAdvancesProgress()
    {
        ...
        await step.ExecuteAsync(new RoomProcessorContext(State, MutationWriter, stats, new NullGlobalMutationWriter(), new NullNotificationSink()), TestContext.Current.CancellationToken);
