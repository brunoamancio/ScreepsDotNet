const _ = {
    ...
    isNumber(value) { return typeof value === 'number' && isFinite(value); }
};
...
if (typeof globalThis !== 'undefined') {
    globalThis.__badge_getSvg = getBadgeSvg;
} else if (typeof global !== 'undefined') {
    global.__badge_getSvg = getBadgeSvg;
} else {
    this.__badge_getSvg = getBadgeSvg;
}
